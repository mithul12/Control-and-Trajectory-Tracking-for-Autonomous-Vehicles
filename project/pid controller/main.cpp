...
int main ()
{
    ...
    static double mean_des_angle = 0.0;
    static double mean_des_throttle = 0.0;
    ...
    h.onMessage([&pid_steer, &pid_throttle, &new_delta_time, &timer, &prev_timer, &i, &prev_timer](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length, uWS::OpCode opCode)
    {
        ...
        if (s != "") 
        {
            ...
            /**
            * TODO: (step 3): Update the delta time with the previous command
            **/
            ...
            **/
            // we pick the point in the desired trajectory that is closest to the 
            ...
            **/
            ...
            /**
            * TODO: (step 2): Update the delta time with the previous command
            **/
            //
            ...
            **/
            ...
            // mean_des_throttle = (i*mean_des_throttle + v_points[i])/(i+1);
            // mean_des_throttle = 0;
            // for (double v:v_points)
            // {
            //     mean_des_throttle += v;
            // }
            // mean_des_throttle = mean_des_throttle/v_points.size();
